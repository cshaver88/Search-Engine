...
/**
 * 
 * ArgumentParser accepts command line arguments and parses them into flag/value
 * pairs to access easily.
 * 
 * @author CaylaR
 * 
 */
public class ArgumentParser {
	...
	public static boolean isFlag(String arg) {
		...
		if (arg.startsWith("- ") || arg.isEmpty() || arg.equalsIgnoreCase("-")
				|| !arg.startsWith("-")) {
			return false;
		} else {
			return true;
	...
	public static boolean isValue(String arg) {
		...
		if (arg.startsWith("-") || arg.startsWith(" ") || arg.isEmpty()) {
			return false;
		} else {
			return true;
		}
